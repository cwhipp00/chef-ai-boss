...
const Auth = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      toast.error(error.message || 'An unexpected error occurred with Google sign-in');
    } finally {
                ...
                <>
                  ...
                  <div className="mt-4 lg:mt-6">
                    ...
                    <Button
                      type="button"
                      variant="outline"
                      className="w-full mt-4 h-9 lg:h-12 text-sm lg:text-base hover:bg-accent/10 transition-all hover:scale-[1.02] touch-target disabled:opacity-50"
